...
public class GCD 
{
	...
	public static void main(String[] args) {
		...
		try
		{
			...
			JOptionPane.showMessageDialog(null, "The greatest common divisor of " + number1 +
					" and " + number2 + " is " + gcd);
		}
	...
	// Returns the largest number which is evenly divisible into two provided numbers.
	public static int getGreatestCommonDivisor ( int number1, int number2 )
	{
		int gcd = 1;
		int divisor = 1;
		while ((divisor != -1) && (divisor <= number2))		//error solved: replaced "<" with "<=" to. caused error when larger number was entered first.
		{
